//++Dubrovnik.CodeGenerator System_Diagnostics_CodeAnalysis_MaybeNullWhenAttribute.m
//
...
@implementation System_Diagnostics_CodeAnalysis_MaybeNullWhenAttribute
...
{
	System_Diagnostics_CodeAnalysis_MaybeNullWhenAttribute * object = [[self alloc] initWithSignature:"bool" withNumArgs:1, &p1];
	return object;
}
