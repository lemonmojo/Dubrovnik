...
@interface System_TimeZoneInfo : System_Object <System_Runtime_Serialization_ISerializable_, System_IEquatableA1_, System_Runtime_Serialization_IDeserializationCallback_>
