//++Dubrovnik.CodeGenerator System_Runtime_CompilerServices_AsyncValueTaskMethodBuilder.m
//
...
@implementation System_Runtime_CompilerServices_AsyncValueTaskMethodBuilder
...
- (System_Threading_Tasks_ValueTask *)task
{
	...
	_task = [System_Threading_Tasks_ValueTask bestObjectWithMonoObject:monoObject];
...
- (void)awaitOnCompleted_withAwaiterRef:(System_Object **)p1 stateMachineRef:(System_Object **)p2 typeParameters:(NSArray<id> *)typeParameter
{
	...
	DBManagedMethod *method = [self methodWithMonoName:"AwaitOnCompleted(System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder/TAwaiter&,System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder/TStateMachine&)" typeParameters:typeParameter];
...
- (void)awaitUnsafeOnCompleted_withAwaiterRef:(System_Object **)p1 stateMachineRef:(System_Object **)p2 typeParameters:(NSArray<id> *)typeParameter
{
	void *refPtr1 = [*p1 monoRTInvokeArg];
	void *refPtr2 = [*p2 monoRTInvokeArg];
	DBManagedMethod *method = [self methodWithMonoName:"AwaitUnsafeOnCompleted(System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder/TAwaiter&,System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder/TStateMachine&)" typeParameters:typeParameter];
	[method invokeMethodWithNumArgs:2, &refPtr1, &refPtr2];
	*p1 = [System_Object bestObjectWithMonoObject:refPtr1];
	*p2 = [System_Object bestObjectWithMonoObject:refPtr2];
}
...
+ (System_Runtime_CompilerServices_AsyncValueTaskMethodBuilder *)create
{
	...
	return [System_Runtime_CompilerServices_AsyncValueTaskMethodBuilder bestObjectWithMonoObject:monoObject];
}
...
{
	void *refPtr1 = [*p1 monoRTInvokeArg];
	DBManagedMethod *method = [self methodWithMonoName:"Start(System.Runtime.CompilerServices.AsyncValueTaskMethodBuilder/TStateMachine&)" typeParameters:typeParameter];
